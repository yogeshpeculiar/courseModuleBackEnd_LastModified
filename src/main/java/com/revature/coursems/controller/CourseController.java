...
public class CourseController {
	...
	public ResponseEntity<HTTPStatusResponse> view() {
		...
		try {
			...
			return new ResponseEntity<>(
					new HTTPStatusResponse(HttpStatus.OK.value(), "data retrived successfully", courseObj),
					HttpStatus.OK);
	...
	public ResponseEntity<HTTPStatusResponse> getCourseById(@PathVariable int id) {
		...
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), "data for the id found", course),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<HTTPStatusResponse> deleteById(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), "deleted given id"),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<HTTPStatusResponse> saveCourse(@RequestBody Course course) {
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), "data inserted successfully"),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
	...
	public ResponseEntity<HTTPStatusResponse> update(@RequestBody updateDTO updateDTOObj) {
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), "data updated successfully"),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage()),
					HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<HTTPStatusResponse> viewLevels() {
		try {
			...
			return new ResponseEntity<>(
					new HTTPStatusResponse(HttpStatus.OK.value(), "data retrived successfully", listOfLevels),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), "data not found"),
					HttpStatus.NOT_FOUND);
		}
	}
	...
	public ResponseEntity<HTTPStatusResponse> viewCategories() {
		try {
			...
			return new ResponseEntity<>(
					new HTTPStatusResponse(HttpStatus.OK.value(), "data retrived successfully", listOfCategories),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), "data not found"),
					HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<HTTPStatusResponse> switchStatus(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), "Status switched successfully"),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<HTTPStatusResponse> viewLevelById(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), "data for the id found", level),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<HTTPStatusResponse> viewCategoryById(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(
					new HTTPStatusResponse(HttpStatus.OK.value(), "data for the id found", category), HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<HTTPStatusResponse> viewDocByCourseId(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(
					new HTTPStatusResponse(HttpStatus.OK.value(), " mapped docs for the id found", listOfDocs),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<HTTPStatusResponse> viewVideoByCourseId(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.OK.value(), " mapped videos for the id found",
					listOfCourseSubscribedVideos), HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<HTTPStatusResponse> deleteCourseVideoMappingById(@PathVariable int id) {
		try {
			...
			return new ResponseEntity<>(
					new HTTPStatusResponse(HttpStatus.OK.value(), " mapped videos for the id are deleted", null),
					HttpStatus.OK);
		} catch (BusinessServiceException e) {
			return new ResponseEntity<>(new HTTPStatusResponse(HttpStatus.NOT_FOUND.value(), e.getMessage()),
					HttpStatus.NOT_FOUND);
